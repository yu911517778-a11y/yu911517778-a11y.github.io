...
const litePagesEntry = `${projectPagesEntry}client-lite-v027.html`;
const liteTempEntry = "https://litter.catbox.moe/xkh2g7.html";
const fullTempEntry = "https://litter.catbox.moe/cxstc3.html";
...
const customerEntries = [
  ...
  ["备用入口 2（项目页完整入口）", `${projectPagesEntry}client-entry-v027.html`],
  ["备用入口 3（72 小时完整 Demo）", fullTempEntry],
